"use strict";
(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[6559],{
...
function DeviceFirmwareVersionChip(props) {
  var device = props.device;
  var firmwareVersionRegister = (0,useChange/* default */.Z)(device, function (_) {
    var _$service;
...
function DeviceTemperatureChip(props) {
  var device = props.device;
  var tempRegister = (0,useChange/* default */.Z)(device, function (_) {
    var _$service2;
