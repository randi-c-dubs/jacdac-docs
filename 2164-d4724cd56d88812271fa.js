...
/* harmony import */ var _hooks_useEvent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(59626);
...
/* harmony import */ var _widgets_useWidgetTheme__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(60650);
/* harmony import */ var _ui_GridHeader__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(95393);
...
function DashboardAzureIoTHub(props) {
  ...
  var connectId = (0,react_use_id_hook__WEBPACK_IMPORTED_MODULE_5__/* .useId */ .Me)();
  var cdMessageId = (0,react_use_id_hook__WEBPACK_IMPORTED_MODULE_5__/* .useId */ .Me)();
  var cdMessageCounter = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(0);
  var {
    0: cdMessage,
    1: setCDMessage
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(JSON.stringify({
  ...
  var hubNameRegister = (0,_hooks_useRegister__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z)(service, _jacdac_ts_jacdac_spec_dist_specconstants__WEBPACK_IMPORTED_MODULE_3__/* .AzureIotHubReg.HubName */ .VNh.HubName);
  var deviceIdRegister = (0,_hooks_useRegister__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z)(service, _jacdac_ts_jacdac_spec_dist_specconstants__WEBPACK_IMPORTED_MODULE_3__/* .AzureIotHubReg.DeviceId */ .VNh.DeviceId);
  var connectionStatusRegister = (0,_hooks_useRegister__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z)(service, _jacdac_ts_jacdac_spec_dist_specconstants__WEBPACK_IMPORTED_MODULE_3__/* .AzureIotHubReg.ConnectionStatus */ .VNh.ConnectionStatus);
  var [hubName] = (0,_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_4__/* .useRegisterUnpackedValue */ .Pf)(hubNameRegister, props);
  var [deviceId] = (0,_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_4__/* .useRegisterUnpackedValue */ .Pf)(deviceIdRegister, props);
  var [connectionStatus] = (0,_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_4__/* .useRegisterUnpackedValue */ .Pf)(connectionStatusRegister, props);
  var connectedEvent = (0,_hooks_useEvent__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)(service, _jacdac_ts_jacdac_spec_dist_specconstants__WEBPACK_IMPORTED_MODULE_3__/* .AzureIotHubEvent.Connected */ .ogr.Connected);
  var disconnectedEvent = (0,_hooks_useEvent__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)(service, _jacdac_ts_jacdac_spec_dist_specconstants__WEBPACK_IMPORTED_MODULE_3__/* .AzureIotHubEvent.Disconnected */ .ogr.Disconnected);
  var messageEvent = (0,_hooks_useEvent__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)(service, _jacdac_ts_jacdac_spec_dist_specconstants__WEBPACK_IMPORTED_MODULE_3__/* .AzureIotHubEvent.Message */ .ogr.Message);
  (0,_jacdac_useChange__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z)(connectedEvent, () => connectionStatusRegister === null || connectionStatusRegister === void 0 ? void 0 : connectionStatusRegister.refresh());
  (0,_jacdac_useChange__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z)(disconnectedEvent, () => connectionStatusRegister === null || connectionStatusRegister === void 0 ? void 0 : connectionStatusRegister.refresh()); // sniff cloud-to-device events

  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => messageEvent === null || messageEvent === void 0 ? void 0 : messageEvent.subscribe(_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_10__/* .EVENT */ .Ks0, () => {
    var {
      data,
      lastDataTimestamp: timestamp
    } = messageEvent;
    if (!data) return;
    var [body] = (0,_jacdac_ts_src_jdom_pack__WEBPACK_IMPORTED_MODULE_9__/* .jdunpack */ .TE)(messageEvent.data, "s");
  ...
  var {
    textPrimary
  } = (0,_widgets_useWidgetTheme__WEBPACK_IMPORTED_MODULE_11__/* .default */ .Z)(color);
  var deviceToCloudMessages = (0,_jacdac_useChange__WEBPACK_IMPORTED_MODULE_7__/* .default */ .Z)(server, _ => _ === null || _ === void 0 ? void 0 : _.deviceToCloudMessages);
  ...
  var handleConnect = /*#__PURE__*/function () {
    var _ref = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_13__/* .default */ .Z)(function* () {
      yield service.sendCmdAsync(connected ? _jacdac_ts_jacdac_spec_dist_specconstants__WEBPACK_IMPORTED_MODULE_3__/* .AzureIotHubCmd.Disconnect */ .r8S.Disconnect : _jacdac_ts_jacdac_spec_dist_specconstants__WEBPACK_IMPORTED_MODULE_3__/* .AzureIotHubCmd.Connect */ .r8S.Connect);
    });
  ...
  var handleSendCloudMessage = /*#__PURE__*/function () {
    var _ref2 = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_13__/* .default */ .Z)(function* () {
      return yield server.emitMessage(cdMessage);
    });
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_14__/* .default */ .Z, {
    ...
    component: "span",
    variant: "subtitle1"
  }, "hub: ", hubName, ", device: ", deviceId), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_16__/* .default */ .Z, {
    checked: connected,
    ...
    id: connectId
  }, connected ? "connected" : "disconnected", " ")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ui_GridHeader__WEBPACK_IMPORTED_MODULE_12__/* .default */ .Z, {
    title: "cloud to device",
    action: server && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_CmdButton__WEBPACK_IMPORTED_MODULE_8__/* .default */ .Z, {
      title: "Send cloud to device message",
      icon: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_icons_ArrowDownward__WEBPACK_IMPORTED_MODULE_17__/* .default */ .Z, null),
      onClick: handleSendCloudMessage,
      disabled: !connected
    })
  }), server && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_14__/* .default */ .Z, {
    item: true,
    xs: 12
    ...
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("pre", null, cdMessages === null || cdMessages === void 0 ? void 0 : cdMessages.map(m => m.counter + ": " + m.body).join("\n"))), deviceToCloudMessages && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ui_GridHeader__WEBPACK_IMPORTED_MODULE_12__/* .default */ .Z, {
    title: "device to cloud"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_14__/* .default */ .Z, {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("pre", null, deviceToCloudMessages.map(m => m.counter + ": " + m.body).join("\n")))));
}
...
//# sourceMappingURL=2164-d4724cd56d88812271fa.js.map