...
function DashboardMatrixKeypad(props) {
  ...
  var [pressed] = (0,_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_2__/* .useRegisterUnpackedValue */ .Pf)(pressedRegister, props);
  var [labels] = (0,_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_2__/* .useRegisterUnpackedValue */ .Pf)(labelsRegister, props);
  ...
  var handleButtonUp = index => () => {
    server.up(index);
    pressedRegister.refresh();
  };

  var handleButtonDown = index => () => {
    server.down(index);
    pressedRegister.refresh();
  }; // add leds
  ...
  var render = () => {
    ...
    for (var row = 0; row < rows; row++) {
      ...
      var _loop = function _loop(col) {
        ...
        var on = (pressed === null || pressed === void 0 ? void 0 : pressed.findIndex(p => p[0] === index)) > -1;
...
//# sourceMappingURL=7859-060d4c03516af2db8c78.js.map