(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[7293],{
...
var base64 = __webpack_require__(19095);

var ieee754 = __webpack_require__(32846);
...
var canPromise = __webpack_require__(17336);

var QRCode = __webpack_require__(93995);

var CanvasRenderer = __webpack_require__(39179);

var SvgRenderer = __webpack_require__(7948);
 ...
 */
var getSymbolSize = __webpack_require__(34696).getSymbolSize;
/**
...
var Mode = __webpack_require__(15507);
/**
...
var BufferUtil = __webpack_require__(49470);
/**
...
var ECLevel = __webpack_require__(91288);
...
var Utils = __webpack_require__(34696);
...
var VersionCheck = __webpack_require__(59036);

var Regex = __webpack_require__(36146);
/**
...
var GF = __webpack_require__(5009);
/**
...
var BitBuffer = __webpack_require__(6399);

var BitMatrix = __webpack_require__(56995);

var AlignmentPattern = __webpack_require__(4028);

var FinderPattern = __webpack_require__(54252);

var MaskPattern = __webpack_require__(8201);

var ECCode = __webpack_require__(34607);

var ReedSolomonEncoder = __webpack_require__(96561);

var Version = __webpack_require__(80954);

var FormatInfo = __webpack_require__(28131);

var Mode = __webpack_require__(15507);

var Segments = __webpack_require__(24150);

var isArray = __webpack_require__(20889);
/**
...
var Polynomial = __webpack_require__(25678);

var Buffer = __webpack_require__(62426)/* .Buffer */ .lW;
...
var NumericData = __webpack_require__(32842);

var AlphanumericData = __webpack_require__(89622);

var ByteData = __webpack_require__(63185);

var KanjiData = __webpack_require__(67298);

var Regex = __webpack_require__(36146);

var Utils = __webpack_require__(34696);

var dijkstra = __webpack_require__(21415);
/**
...
var isArray = __webpack_require__(20889); // Generator polynomial used to encode version information
...
var Utils = __webpack_require__(59777);
...
/* harmony import */ var qrcode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30631);
...
function useQRCodeSCR(url, layer, size, mirror, margin) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => setError(undefined), deps);
  (0,_useEffectAsync__WEBPACK_IMPORTED_MODULE_2__/* .default */ .Z)( /*#__PURE__*/function () {
    var _ref = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)(function* (mounted) {
      setImage(undefined);
      setScr(undefined);
      setError(undefined);
      ...
      try {
        if (!mounted()) return;
        var qr = qrcode__WEBPACK_IMPORTED_MODULE_0__.create(url, {
          errorCorrectionLevel: "medium"
        });
        var _numBlocks = qr.modules.size;
        var ptr = 0;
        var code = {};

        for (var y = 0; y < _numBlocks; ++y) {
          for (var x = 0; x < _numBlocks; ++x) {
            var xx = !mirror ? _numBlocks - x - 1 : x;
            code[xx + margin + "," + (_numBlocks - y - 1 + margin)] = !!qr.modules.data[ptr++];
          }
        }

        setNumBlocks(_numBlocks);
        var utfcode = yield qrcode__WEBPACK_IMPORTED_MODULE_0__.toString(url, {
          margin: 1,
          scale: 1,
          errorCorrectionLevel: "medium",
          type: "utf8"
        ...
        var _scr = "# QRCode for " + url + " (" + _numBlocks + "x" + _numBlocks + " at " + size + "mm)\n";

        _scr += "LAYER " + layer + ";\n";
        _scr += "GRID mm;\n";
        var kicadTimestamp = (Date.now() / 1000 | 0).toString(16).toUpperCase();

        var _kicad = "(module QrCode (layer F.Cu) (tedit " + kicadTimestamp + ")\n";
        ...
        for (var _y = 0; _y < _numBlocks; _y++) {
          ...
          while (_x2 < _numBlocks) {
            ...
            var alt = ["Fill", mirror ? "TopOverlay" : "BottomOverlay", "No Net", f(x0), f(y0), f(x1), f(y1), "false", "false", "0.0", "0", "none", "0", "none"];
            _altium += alt.join("\t") + "\r\n";
            var kx0 = f(x0 - mid);
            var ky0 = f(-(y0 - mid));
            var kx1 = f(x1 - mid);
        ...
        var frame = (x0, y0, x1, y1) => {
          var q = n => (n * (_numBlocks * size / 2 + 0.0001)).toFixed(4);
        ...
        frame(1, 1, 1, -1);
        _kicad += ")\n";
        var max_x = f(_numBlocks * size);
        var max_y = f(_numBlocks * size);
        _scr += "GRID LAST;\n";
...
function SilkQRCode(props) {
  ...
  var {
    ...
    error,
    numBlocks
  } = useQRCodeSCR(url, eagleLayer, size, mirror, margin);
  if (!url) return null;
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, error && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_ui_Alert__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
    severity: "warning"
  }, error), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z, {
    container: true,
    spacing: 1
  }, imageUri && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z, {
    item: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z, {
    href: imageUri,
    variant: "outlined",
    download: "qrcode.svg"
  }, "Download SVG")), scr && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z, {
    item: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z, {
    href: scrUri,
    variant: "outlined",
    download: "qrcode.scr"
  }, "Download SCR for Eagle")), kicad && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z, {
    item: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z, {
    href: kicadUri,
    variant: "outlined",
    download: "QrCode.kicad_mod"
  }, "Download kicad_mod")), altium && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__/* .default */ .Z, {
    item: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z, {
    href: altiumUri,
    variant: "outlined",
    download: "QrCode.txt"
  }, "Download CSV for Altium"))), image && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("h3", null, "Original size"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("img", {
    className: "pixelated",
    style: {
    ...
    src: imageUri,
    alt: "QR code of " + url
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("h3", null, "Zoomed"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("img", {
    className: "pixelated",
    style: {
      width: "10rem"
    },
...
//# sourceMappingURL=7293-e5ba90390ac889e07ddf.js.map