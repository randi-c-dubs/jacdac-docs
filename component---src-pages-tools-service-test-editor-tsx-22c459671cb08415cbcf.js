(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[6091,5133],{
...
var servers = __webpack_require__(27986);
...
function SelectServiceGrid(props) {
  ...
  var handleSelect = service => () => onSelect(service);

  return /*#__PURE__*/react.createElement(react.Fragment, null, !!services.length && /*#__PURE__*/react.createElement(Grid/* default */.Z, {
    container: true,
    spacing: 2
  }, services.map(service => /*#__PURE__*/react.createElement(Grid/* default */.Z, Object.assign({
    key: service.id,
    item: true
    ...
    disabled: disabled
  }, buttonText || "Select")))))), !(services !== null && services !== void 0 && services.length) && /*#__PURE__*/react.createElement(Alert/* default */.Z, {
    severity: "info"
...
function Diagnostics(props) {
  ...
  var handleStartSimulator = () => (0,servers/* addServiceProvider */.Q6)(bus, hostDefinition);
...
function ServiceTest(props) {
  var {
    serviceSpec,
    showStartSimulator,
    serviceTest = (0,testspec/* serviceTestFromServiceClass */.H)(serviceSpec === null || serviceSpec === void 0 ? void 0 : serviceSpec.classIdentifier)
  } = props;
  var {
  ...
  var handleSelect = service => setService(service); // clear selected service when json changes
  ...
  (0,react.useEffect)(() => {
    ...
    return service === null || service === void 0 ? void 0 : (_service$device = service.device) === null || _service$device === void 0 ? void 0 : _service$device.subscribe(constants/* DISCONNECT */.PYu, () => {
      setService(undefined);
    });
  }, [service]);
...
var GithubPullRequestButton = /*#__PURE__*/(0,react.lazy)(() => Promise.all(/* import() */[__webpack_require__.e(317), __webpack_require__.e(5133)]).then(__webpack_require__.bind(__webpack_require__, 22632)));
...
function parseSpecificationTestMarkdownToJSON(filecontent, spec, filename) {
  ...
  var testHeading = "";
  var testPrompt = "";
  var symbolResolver = new jdutils/* SpecSymbolResolver */.ll(spec, undefined, e => error(e));
  var checkExpression = new jdutils/* VMChecker */.Ys(symbolResolver, t => supportedExpressions.indexOf(t) >= 0, e => error(e));
  ...
  function processCommand(expanded) {
    ...
    if (ret) {
      var [command, _root] = ret; // check all calls in subexpressions
    ...
    function processCalls(command, root) {
      ...
      args.forEach((arg, a) => {
        ...
        (0,jdutils/* exprVisitor */.ao)(root, arg, (parent, callExpr) => {
          ...
          var tef = testExpressionFunctions.find(r => id == r.id);
          ...
          if (tef.context === "expression" || tef.context === "either") {
            ...
            (0,jdutils/* exprVisitor */.ao)(null, callExpr, (parent, ce) => {
...
function ServiceTestEditor() {
  ...
  var [serviceClass, setServiceClass] = (0,useLocalStorage/* default */.Z)(SERVICE_TEST_SERVICE_STORAGE_KEY, constants/* SRV_BUTTON */.XJR);
  var [source, setSource] = (0,useLocalStorage/* default */.Z)(SERVICE_TEST_SOURCE_STORAGE_KEY, "");
  var [markdownSource, setMarkdownSource] = (0,useLocalStorage/* default */.Z)(SERVICE_MARKDOWN_SOURCE_STORAGE_KEY, "");
  var serviceSpec = (0,react.useMemo)(() => (0,spec/* serviceSpecificationFromClassIdentifier */.d5)(serviceClass), [serviceClass]);
  var json = (0,react.useMemo)(() => parseSpecificationTestMarkdownToJSON(source, serviceSpec), [source, serviceSpec]);
  ...
  var handleLoadFromGithub = /*#__PURE__*/function () {
    var _ref = (0,asyncToGenerator/* default */.Z)(function* () {
      try {
        var ghSource = yield (0,github/* fetchText */.s8)("microsoft/jacdac", "main", "services/tests/" + serviceSpec.shortId + ".md", "text/plain");
        setSource(ghSource || "");
      } catch (e) {
        setError(e);
      }
      ...
      try {
        var _ghSource = yield (0,github/* fetchText */.s8)("microsoft/jacdac", "main", "services/" + serviceSpec.shortId + ".md", "text/plain");
...
//# sourceMappingURL=component---src-pages-tools-service-test-editor-tsx-22c459671cb08415cbcf.js.map