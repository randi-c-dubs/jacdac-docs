...
function SchemaForm(props) {
  ...
  var handleIntegerChange = function handleIntegerChange(event) {
    var v = parseInt(event.target.value);
    if (!isNaN(v)) setValue(v);
  };

  var handleCheckedChange = function handleCheckedChange(event, checked) {
    setValue(checked);
  };
...
function PropertiesForm(props) {
  var properties = props.properties,
      required = props.required,
      value = props.value,
      setValue = props.setValue; // eslint-disable-next-line @typescript-eslint/no-explicit-any

  var handleSetValue = function handleSetValue(key, v) {
    return function (newValue) {
      var _objectSpread2;

      setValue(_objectSpread(_objectSpread({}, v || {}), {}, (_objectSpread2 = {}, _objectSpread2[key] = newValue, _objectSpread2)));
    };
  };

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, Object.entries(properties).map(function (_ref) {
    var key = _ref[0],
        schema = _ref[1];
