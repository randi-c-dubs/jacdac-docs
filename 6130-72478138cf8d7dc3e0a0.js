(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[6130],{
...
var elasticlunr = __webpack_require__(27815);
...
function useSearchIndex() {
  var {
    siteSearchIndex
  } = (0,gatsby_browser_entry.useStaticQuery)("2744294623");
  var index = (0,react.useRef)(elasticlunr.Index.load(siteSearchIndex.index));
  return index.current;
}
;// CONCATENATED MODULE: ./src/components/useDrawerSearchResults.ts




function useDrawerSearchResults() {
  var _lastResult$current;

  var index = useSearchIndex();
  var {
    searchQuery: _searchQuery
  } = (0,react.useContext)(AppContext/* default */.ZP);
  var [searchQuery] = (0,useDebounce/* default */.Z)(_searchQuery, 500); // debounce duplicate search

  var lastResult = (0,react.useRef)(undefined);
  if (((_lastResult$current = lastResult.current) === null || _lastResult$current === void 0 ? void 0 : _lastResult$current.searchQuery) === searchQuery) return lastResult.current.nodes; // spin up search
  ...
  if (searchQuery && index) {
    ...
    var indexDocs = results.map(_ref => {
      var {
        ref
      } = _ref;
      return index.documentStore.getDoc(ref);
    });
    nodes = indexDocs.map(id => ({
      title: id.title,
      url: id.url
    }));
  } // cache result
...
;// CONCATENATED MODULE: ./src/components/DrawerSearchResults.tsx





function DrawerSearchResults() {
  var results = useDrawerSearchResults();
  return /*#__PURE__*/react.createElement(List/* default */.Z, null, !results.length && /*#__PURE__*/react.createElement(ListItem/* default */.Z, null, /*#__PURE__*/react.createElement(Alert/* default */.Z, {
    severity: "info"
...
//# sourceMappingURL=6130-72478138cf8d7dc3e0a0.js.map