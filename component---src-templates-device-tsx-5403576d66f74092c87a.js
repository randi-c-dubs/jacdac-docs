...
function toDTMI(segments, version) {
  return ("dtmi:jacdac:" + (0,_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z)(segments).map(seg => seg === undefined ? "???" : typeof seg === "string" ? seg : "x" + seg.toString(16)).map(seg => seg.replace(/(-|_)/g, "")).join(":") + ";" + (version !== undefined ? version : 1)).toLowerCase();
}
