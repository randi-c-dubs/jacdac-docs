...
/* harmony import */ var _babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(85061);
...
var HORIZON = 10;
function TwinWidget() {
  var _useContext = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_jacdac_Context__WEBPACK_IMPORTED_MODULE_9__/* .default */ .Z),
      bus = _useContext.bus;
  ...
  var _useBlockData = (0,_useBlockData__WEBPACK_IMPORTED_MODULE_8__/* .default */ .Z)(sourceBlock, []),
  ...
  var setRegisterData = function setRegisterData() {
    ...
    if (newValue !== undefined) {
      var newRow = (0,_jacdac_ts_src_jdom_utils__WEBPACK_IMPORTED_MODULE_10__/* .toMap */ .qL)(register.fields, function (f) {
        return f.name;
      }, function (f, i) {
        return newValue[i];
      });
