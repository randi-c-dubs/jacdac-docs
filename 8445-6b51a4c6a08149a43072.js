...
function FilterMenu(props) {
  ...
  var services = (0,utils/* uniqueMap */.EM)((0,utils/* arrayConcatMany */.ue)(devices.map(device => device.services())), service => service.serviceClass.toString(), srv => srv);
  var serviceIds = services.map(service => {
  ...
  var serviceSpecs = services.map(service => service.specification).filter(spec => !!spec);
  var packets = (0,utils/* uniqueMap */.EM)((0,utils/* arrayConcatMany */.ue)(serviceSpecs.map(spec => spec.packets.filter(pkt => pkt.name))), pkt => pkt.identifier.toString(16), pkt => pkt);

  var packetFilter = pkt => (0,spec/* isRegister */.x5)(pkt) ? "register" : (0,spec/* isCommand */.ao)(pkt) ? "command" : (0,spec/* isEvent */.cO)(pkt) ? "event" : (0,spec/* isPipeReport */._5)(pkt) ? "pipe" : "pkt";

  var handleAdd = filter => () => {
  ...
  return /*#__PURE__*/react.createElement(Box/* default */.Z, {
    ...
    onClose: handleClose
  }, kinds.map(kind => /*#__PURE__*/react.createElement(MenuItem/* default */.Z, {
    key: kind,
    ...
    variant: "subtitle2"
  }, "self:false")), devices === null || devices === void 0 ? void 0 : devices.map(device => /*#__PURE__*/react.createElement(MenuItem/* default */.Z, {
    key: "dev:" + device.id,
    ...
    variant: "subtitle2"
  }, "dev:", device.name || device.shortId))), serviceIds === null || serviceIds === void 0 ? void 0 : serviceIds.map(srv => /*#__PURE__*/react.createElement(MenuItem/* default */.Z, {
    key: "srv:" + srv,
    ...
    variant: "subtitle2"
  }, "srv:", srv))), packets === null || packets === void 0 ? void 0 : packets.map(pkt => /*#__PURE__*/react.createElement(MenuItem/* default */.Z, {
...
function PacketFilter() {
  ...
  var {
    0: text,
    1: setText
  } = (0,react.useState)(filter);
  var [debouncedText] = (0,useDebounce/* default */.Z)(text, 1000);
  var filterId = (0,react_use_id_hook_esm/* useId */.Me)(); // background filter update

  (0,react.useEffect)(() => setText(filter), [filter]); // set filter once bounced
...
var PacketView_useStyles = (0,makeStyles/* default */.Z)(() => (0,createStyles/* default */.Z)({
  items: {
    flex: 1
  }
}));
...
//# sourceMappingURL=8445-6b51a4c6a08149a43072.js.map