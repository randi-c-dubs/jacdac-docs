...
function cmdToTestFunction(cmd) {
  ...
  return (0,jdtestfuns/* getTestCommandFunctions */.f)().find(t => t.id == id);
}
...
var JDCommandEvaluator = /*#__PURE__*/function () {
  ...
  _proto.start = function start() {
    ...
    switch (testFun.id) {
      ...
      case "nextEvent":
        {
          (0,jdutils/* exprVisitor */.ao)(null, args, (p, ce) => {
      ...
      case "events":
        {
          ...
          this._eventsComplete = eventList.elements.map(id => id.name);
          break;
        }
    ...
    startExprs.forEach(child => {
      if (this._startExpressions.findIndex(r => r.e === child) < 0) {
        var exprEval = new vm_expr/* VMExprEvaluator */.W(this.env, this.callEval([]));
  ...
  _proto.createPrompt = function createPrompt() {
    var testFun = cmdToTestFunction(this.command);
    var replaceId = this.command.call.arguments.map((a, i) => {
      return ["{" + (i + 1) + "}", (0,vm_expr/* unparse */.Z)(a)];
    });
    var replaceVal = this.command.call.arguments.map((a, i) => {
      var aStart = this._startExpressions.find(r => r.e === a);
  ...
  _proto.evaluateAsync = /*#__PURE__*/function () {
    var _evaluateAsync = (0,asyncToGenerator/* default */.Z)(function* () {
      var testFun = cmdToTestFunction(this.command);
      var args = this.command.call.arguments;
      this._status = JDTestCommandStatus.Active;
      this._progress = "";
      ...
      switch (testFun.id) {
        ...
        case "closeTo":
          {
            ...
            var expr = new vm_expr/* VMExprEvaluator */.W(this.env, this.callEval(this._startExpressions));
            var ev = yield expr.evalAsync(args[0]);
        ...
        case "decreases":
          {
            var regSaved = this._startExpressions.find(r => r.e === args[0]);

            var regValue = this.env((0,vm_expr/* unparse */.Z)(args[0]));
        ...
        case "decreasesBy":
          {
            ...
            var _regValue = this.env((0,vm_expr/* unparse */.Z)(args[0]));
        ...
        case "stepsDownTo":
          {
            ...
            var _regValue2 = this.env((0,vm_expr/* unparse */.Z)(args[0]));
        ...
        case "assign":
          {
            var _expr = new vm_expr/* VMExprEvaluator */.W(this.env, this.callEval(this._startExpressions));

            var _ev3 = _expr.evalAsync(args[1]);

            var reg = args[0];
            yield this.testRunner.serviceTestRunner.writeRegisterAsync(reg.name, _ev3);
            this._status = JDTestCommandStatus.Passed;
...
var JDTestCommandRunner = /*#__PURE__*/function (_JDEventSource) {
  ...
  function JDTestCommandRunner(testRunner, command) {
    ...
    _this._status = JDTestCommandStatus.NotReady;
    _this._output = {
      message: "",
      progress: ""
    };
    _this._commandEvaluator = null;
  ...
  _proto2.envChangeAsync = /*#__PURE__*/function () {
    var _envChangeAsync = (0,asyncToGenerator/* default */.Z)(function* () {
      if (this.isActive) {
        ...
        if (this._commandEvaluator) {
          try {
            yield this._commandEvaluator.evaluateAsync();
            var newOutput = {
              message: this._commandEvaluator.prompt,
              progress: this._commandEvaluator.progress
            };
            this.output = newOutput;
            if (this._commandEvaluator.status === JDTestCommandStatus.RequiresUserInput) this.status = JDTestCommandStatus.RequiresUserInput;else yield this.finishAsync(this._commandEvaluator.status);
  ...
  _proto2.cancelAsync = /*#__PURE__*/function () {
    var _cancelAsync = (0,asyncToGenerator/* default */.Z)(function* () {
      yield this.finishAsync(JDTestCommandStatus.Failed);
    });
  ...
  _proto2.finishAsync = /*#__PURE__*/function () {
    var _finishAsync = (0,asyncToGenerator/* default */.Z)(function* (s) {
      if (this.isActive && (s === JDTestCommandStatus.Failed || s === JDTestCommandStatus.Passed)) {
        this.status = s;
        yield this.testRunner.finishCommandAsync();
      }
    });
...
var JDTestRunner = /*#__PURE__*/function (_JDEventSource2) {
  ...
  function JDTestRunner(serviceTestRunner, testSpec) {
    ...
    _this2._status = JDTestStatus.NotReady;
    _this2.serviceTestRunner = serviceTestRunner;
    _this2.testSpec = testSpec;
    _this2.commands = testSpec.testCommands.map(c => new JDTestCommandRunner((0,assertThisInitialized/* default */.Z)(_this2), c));
    return _this2;
  }
  ...
  _proto3.setCommandIndex = /*#__PURE__*/function () {
    var _setCommandIndex = (0,asyncToGenerator/* default */.Z)(function* (index) {
      if (this._commandIndex !== index) {
        var _this$currentCommand;

        this._commandIndex = index;
        yield (_this$currentCommand = this.currentCommand) === null || _this$currentCommand === void 0 ? void 0 : _this$currentCommand.startAsync();
        this.emit(constants/* CHANGE */.Ver);
      }
    });
  ...
  _proto3.envChangeAsync = /*#__PURE__*/function () {
    var _envChangeAsync2 = (0,asyncToGenerator/* default */.Z)(function* () {
      if (this.status === JDTestStatus.Active) {
        var _this$currentCommand2;

        yield (_this$currentCommand2 = this.currentCommand) === null || _this$currentCommand2 === void 0 ? void 0 : _this$currentCommand2.envChangeAsync();
      }
    });
  ...
  _proto3.eventChangeAsync = /*#__PURE__*/function () {
    var _eventChangeAsync = (0,asyncToGenerator/* default */.Z)(function* (event) {
      if (this.status === JDTestStatus.Active) {
  ...
  _proto3.finishCommandAsync = /*#__PURE__*/function () {
    var _finishCommandAsync = (0,asyncToGenerator/* default */.Z)(function* () {
      if (this.getCommandIndex() === this.commands.length - 1) this.finish(commandStatusToTestStatus(this.currentCommand.status));else yield this.setCommandIndex(this.getCommandIndex() + 1);
    });
...
var JDServiceTestRunner = /*#__PURE__*/function (_JDServiceClient) {
  ...
  function JDServiceTestRunner(testSpec, service) {
    ...
    _this3 = _JDServiceClient.call(this, service) || this;
    _this3._testIndex = -1;
    _this3.testSpec = testSpec;
    _this3._env = new client/* VMServiceClient */.z(service);
    _this3.tests = _this3.testSpec.tests.map(t => new JDTestRunner((0,assertThisInitialized/* default */.Z)(_this3), t));

    _this3.testSpec.tests.forEach(t => {
      t.events.forEach(s => {
        var eventName = s.substr(s.indexOf(".") + 1);

        _this3._env.registerEvent(eventName, /*#__PURE__*/(0,asyncToGenerator/* default */.Z)(function* () {
          try {
            var _this3$currentTest;

            yield (_this3$currentTest = _this3.currentTest) === null || _this3$currentTest === void 0 ? void 0 : _this3$currentTest.eventChangeAsync(eventName);
          } catch (e) {//
          }
        }));
      });
      t.registers.forEach(s => {
        ...
        _this3._env.registerRegister(regName, /*#__PURE__*/(0,asyncToGenerator/* default */.Z)(function* () {
          try {
            var _this3$currentTest2;

            yield (_this3$currentTest2 = _this3.currentTest) === null || _this3$currentTest2 === void 0 ? void 0 : _this3$currentTest2.envChangeAsync();
          } catch (e) {//
          }
        }));
      });
  ...
  /*#__PURE__*/
  function () {
    var _writeRegisterAsync = (0,asyncToGenerator/* default */.Z)(function* (regName, val) {
      yield this._env.writeRegisterAsync(regName, val);
    });
...
function TestStatusIcon(props) {
  ...
  var status = (0,useChange/* default */.Z)(test, t => t.status);
...
function TestListItem(props) {
  ...
  var description = (0,useChange/* default */.Z)(test, t => t.description);
  var selected = test === currentTest;

  var handleSelectTest = () => onSelectTest(test);
...
function TestList(props) {
  ...
  var stats = (0,useChange/* default */.Z)(testRunner, r => r.stats());
  ...
  }, tests === null || tests === void 0 ? void 0 : tests.map((test, i) => /*#__PURE__*/react.createElement(TestListItem, {
    key: i,
    test: test,
...
function CommandStatusIcon(props) {
  ...
  var status = (0,useChange/* default */.Z)(command, c => c.status);
...
function CommandListItem(props) {
  ...
  var {
    message,
    progress
  } = (0,useChange/* default */.Z)(command, c => c.output);
  var status = (0,useChange/* default */.Z)(command, c => c.status);

  var handleAnswer = status => () => command.finish(status);
...
function ActiveTest(props) {
  ...
  var handleRestart = () => test.start();

  var handleNext = () => test.next(); // auto start


  (0,react.useEffect)(() => test.start(), [test]);
  return /*#__PURE__*/react.createElement(Card/* default */.Z, null, /*#__PURE__*/react.createElement(CardContent/* default */.Z, null, /*#__PURE__*/react.createElement(Typography/* default */.Z, {
    ...
    dense: false
  }, commands.map((cmd, i) => /*#__PURE__*/react.createElement(CommandListItem, {
    key: i,
    command: cmd
...
function ServiceTestRunner(props) {
  var {
    service,
    serviceTest = (0,testspec/* serviceTestFromServiceClass */.H)(service.serviceClass)
  } = props;
  var factory = (0,react.useCallback)(service => serviceTest && new JDServiceTestRunner(serviceTest, service), [service, serviceTest]);
  var testRunner = (0,useServiceClient/* default */.Z)(service, factory);
  var currentTest = (0,useChange/* default */.Z)(testRunner, t => t === null || t === void 0 ? void 0 : t.currentTest);

  var handleSelectTest = test => {
...
//# sourceMappingURL=859a83de993caea7524bf57c2975f3be6812c8c3-54c736e25b185e58fb2b.js.map