...
function BytesBarGraphWidget(props) {
  ...
  var m = 2;
  var dy = (h - 2 * m) / 0xff;
  (0,react.useEffect)(() => visible && (register === null || register === void 0 ? void 0 : register.subscribe(constants/* REPORT_UPDATE */.rGZ, () => {
...
function HostMicrophoneButton(props) {
  ...
  var [fftPow2Size] = (0,useRegisterValue/* useRegisterUnpackedValue */.Pf)(fftPow2SizeRegister, props);
  var fftSize = 1 << (fftPow2Size || 5);
  var [smoothingTimeConstant] = (0,useRegisterValue/* useRegisterUnpackedValue */.Pf)(smoothingTimeConstantRegister, props);
  var {
    spectrum,
    onClickActivateMicrophone
  } = useMicrophoneSpectrum(enabled && !!server, {
    fftSize,
  ...
  (0,react.useEffect)(() => visible && enabled && (server === null || server === void 0 ? void 0 : server.subscribe(constants/* REFRESH */.RGM, () => {
...
//# sourceMappingURL=4666-b8e428b5fda8096772c7.js.map