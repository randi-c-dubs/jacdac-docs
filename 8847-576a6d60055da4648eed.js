...
function DashboardTrafficLight(props) {
  ...
  var redRegister = (0,_hooks_useRegister__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)(service, _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__/* .TrafficLightReg.Red */ .r6v.Red);
  var orangeRegister = (0,_hooks_useRegister__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)(service, _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__/* .TrafficLightReg.Orange */ .r6v.Orange);
  var greenRegister = (0,_hooks_useRegister__WEBPACK_IMPORTED_MODULE_6__/* .default */ .Z)(service, _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__/* .TrafficLightReg.Green */ .r6v.Green);
  var red = (0,_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_2__/* .useRegisterBoolValue */ .I8)(redRegister, props);
  var orange = (0,_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_2__/* .useRegisterBoolValue */ .I8)(orangeRegister, props);
  var green = (0,_jacdac_useRegisterValue__WEBPACK_IMPORTED_MODULE_2__/* .useRegisterBoolValue */ .I8)(greenRegister, props);
  var lightRegs = [_jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__/* .TrafficLightReg.Red */ .r6v.Red, _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__/* .TrafficLightReg.Orange */ .r6v.Orange, _jacdac_ts_src_jdom_constants__WEBPACK_IMPORTED_MODULE_1__/* .TrafficLightReg.Green */ .r6v.Green];
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_widgets_SvgWidget__WEBPACK_IMPORTED_MODULE_3__/* .default */ .Z, {
    ...
    ref: widgetRef
  }, navProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("rect", {
    x: 0,
    y: 0,
    width: w,
    height: h,
    ...
    var onDown = /*#__PURE__*/function () {
      var _ref = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_10__/* .default */ .Z)(function* () {
        var reg = service.register(lightRegs[i]);
        yield reg.sendSetBoolAsync(!v, true);
      });
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(TrafficLight, {
      key: i,
      cx: cx,
      cy: cy,
...
//# sourceMappingURL=8847-576a6d60055da4648eed.js.map